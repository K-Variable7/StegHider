      ...
      <main className="container mx-auto px-6 py-8">
        {!isConnected ? (
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white mb-4">🎉 Seasonal Events</h2>
            <p className="text-xl text-gray-300 mb-8">
              Connect your wallet to participate in exciting seasonal events and earn bonus rewards!
            </p>
            <ConnectButton />
          </div>
        ) : (
